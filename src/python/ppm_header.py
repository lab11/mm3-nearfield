...
class my_top_block(grc_wxgui.top_block_gui):
   def __init__(self, options):
	...
	if options.playback == True:
		self.source2 = blocks.file_source(gr.sizeof_gr_complex, "iq_data_v8_chip_18_FAFA.dat", True)
...
def main():
	...
	parser.add_option("-n", "--packet-len", type="int", default=16, help="Packet Length (bits")
